...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _signUp() async {
    ...
    if (_pwController.text != _rePwController.text) {
      setState(() { _isPasswordMatched = false; });
      return;
    }
    setState(() { _isPasswordMatched = true; });
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: const Text('로그인하세요', style: TextStyle(color: Colors.purple)),
                  ),
                ],
              ),
            ],
